...
- Use the same `DATABASE_URL` from Neon (Pooled connection)
...
Use the seed script or create manually in Neon console.
...
- [ ] Verify mobile navigation menu works smoothly
- [ ] Test infinite scroll on archive page
...
2. **SEO**: Meta tags and Open Graph already configured, consider adding sitemap.xml
3. **Analytics**: Integrate Google Analytics or Plausible
4. **Monitoring**: Set up Sentry or similar for error tracking
5. **Backups**: Configure Neon backup retention (7 days included in free tier)
